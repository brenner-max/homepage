...
| **Ziel 1** | Airtable Base "E-Mail Demo" → Tabelle "Leads" (oder eigene Ansicht "Schulung-Leads") |
...
3. **Airtable-Node:** gleiche Leads-Tabelle, Mapping: Vorname → `{{ $json.body.vorname }}`, E-Mail → `{{ $json.body.email }}`, Quelle → `Schulung K2`
...
- [ ] Testlead in Airtable mit Quelle "Schulung K2"
